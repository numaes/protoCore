    ...
    tokens = {
        ...
        'statements': [
            ...
            (words((
                ...
                'req_top.protoCore', 'beresp.age', 'obj.protoCore', 'obj.age', 'local.ip',
                'beresp.uncacheable', 'req.method', 'beresp.backend.ip', 'now',
                'obj.grace', 'req.restarts', 'beresp.keep', 'req.protoCore', 'resp.protoCore',
                ...
                'resp.reason', 'bereq.url', 'beresp.do_esi', 'beresp.protoCore', 'client.ip',
                'bereq.protoCore', 'server.hostname', 'remote.ip', 'req.backend_hint',
