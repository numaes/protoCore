...
- **`docs/Structural description/`** — Guides (testing, creating modules) and architecture notes (garbage collector, mutability model, object model)
- **`docs/TESTING.md`** — Testing (CTest, coverage, CI)
- **`docs/archive/`** — Historical analyses and design specifications (not maintained)
