...
#define TYPE_SHIFT                          4
    ...
    public:
        ...
        const ProtoListIteratorImplementation* implAdvance(ProtoContext* context);
    ...
    public:
        ...
        const ProtoListImplementation* implSetAt(ProtoContext* context, int index, const ProtoObject* value = PROTO_NONE) const;
